...
class StimulusClassifierConfig:
    ...
    def __init__(self):
        self.class_ignore_list = ["person", "fungus", "fruit", "plant"]
        self.label_level = 0
        self.epochs = 20
        self.learning_rate = 0.001
        self.batch_size = 128
        self.latent_emb_size = 100
        self.model_names = ["vgg-11", "resnet-50"]
        ...
        self.img_transform = {
            ...
            "train": A.Compose(
                [
                    ...
                    A.ShiftScaleRotate(
                        shift_limit=0.05, scale_limit=0.05, rotate_limit=0.05, p=0.5
                    ),
